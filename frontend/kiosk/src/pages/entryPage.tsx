	...
	return (
		<div className="w-full h-screen bg-primary-color">
			...
			<div className="absolute w-full bottom-[50px]">
				...
				<div className="flex justify-center space-x-10 mx-auto w-2/3">
					<div
						id="button"
						className="flex justify-center items-center rounded-2xl text-lg font-bold text-primary-color bg-white w-[200px] h-32 border border-primary-color border-4"
						onClick={handleClick}
					>
						한글
					</div>
