...
public class OrderItemConsumer {
    ...
    public void consumeConnectRoom(String message) {
        try {
            ConnectRoomMessage connectRoomMessage = new Gson().fromJson(message, ConnectRoomMessage.class);
    ...
    public void consumeAddOrderItem(String message) {
        try {
            AddOrderItemMessage addOrderItemMessage = new Gson().fromJson(message, AddOrderItemMessage.class);
    ...
    public void consumeDeleteOrderItem(String message) {
        try {
            DeleteOrderItemMessage deleteOrderItemMessage = new Gson().fromJson(message, DeleteOrderItemMessage.class);
    ...
    public void consumeStartGame(String message) {
        try {
            StartGameMessage startGameMessage = new Gson().fromJson(message, StartGameMessage.class);
    ...
    public void consumeRunWheel(String message) {
        try {
            RunWheelMessage runWheelMessage = new Gson().fromJson(message, RunWheelMessage.class);
    ...
    public void consumeLeaveRoom(String message) {
        try {
            LeaveRoomMessage leaveRoomMessage = new Gson().fromJson(message, LeaveRoomMessage.class);
